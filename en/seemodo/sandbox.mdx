...
The **cloud icon** next to the terminal button opens Seemodo Cloud — for connecting a database, storage, and authentication to your sandbox app. See [Seemodo Cloud](/seemodo/cloud).
