...
flowchart LR
    ...
    SeemodAIServer -->|Code-Änderungen| Files
...
stateDiagram-v2
    ...
    ViteStart --> SeemodAIStart: Vite bereit
    SeemodAIStart --> Bereit: Alle Dienste aktiv
...
sequenceDiagram
    ...
    API->>SeemodAI: Prompt mit Kontext senden
    
    loop Streaming-Antwort
        SeemodAI->>API: Code-Änderungen SSE
        API->>Frontend: Updates streamen
    end
    
    SeemodAI->>Sandbox: Dateien schreiben
