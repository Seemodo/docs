...
Erstellt eine Sandbox mit dem Modal Cloud-Backend mit OpenCode KI-Integration.
...
- Modal-Sandboxes beinhalten OpenCode KI für intelligente Code-Generierung
- Vercel-Sandboxes sind leichter aber ohne OpenCode
