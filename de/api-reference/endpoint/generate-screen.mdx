...
sequenceDiagram
    ...
    API->>SeemodAI: Generierungs-Anfrage senden
    SeemodAI->>Sandbox: list_files()
    SeemodAI->>Sandbox: read_file(App.tsx)
    SeemodAI->>Sandbox: write_file(pages/page.tsx)
    SeemodAI->>Sandbox: App.tsx Routen aktualisieren
    SeemodAI->>Sandbox: Vite-Logs prüfen
    SeemodAI-->>API: Generierung abgeschlossen
