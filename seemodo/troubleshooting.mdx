...
If the OpenCode panel shows "Thinking" indefinitely:
...
| `OPENCODE_CONNECTION_FAILED` | Can't reach OpenCode server | Wait for sandbox to fully initialize |
...
2. **Export logs** - Click "Export" in the OpenCode panel
